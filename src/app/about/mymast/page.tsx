        ...
        <>
            ...
            <main>
                <Section heading="What is MyMAST?">
                    <p>
                        For many years, we've far too often encountered problems with our signup processes, whether that being web forms glitching out, confirmation emails being received late (or not at all), or even all of our emails getting marked as spam.
                ...
                <Section heading="What does this mean?">
                    <p>MyMAST has two types of accounts: parent accounts and volunteer accounts.</p>
                    <Card.Norm header="Are you a parent?">
                        <p>
                            When you create a parent account (by selecting "I'm a parent" during account creation), we'll save all the information you enter and automatically apply it to all of your future enrollments.
                            <br/>
                            You can add as many students as you'd like to your MyMAST account. You're required to add at least one student during account creation, but can always manage the students linked to your account (including adding and deleting students) from the "Settings" page in MyMAST.
                        </p>
                        <p>
                            ...
                            <br/>
                            Then, simply select the students you wish to enroll. Depending on the program, you may have to answer a few questions, such as what course do you want to enroll in, and during what week(s). Then you'll be provided a link to complete the Program Enrollment Agreement and another link to make an optional (but helpful) donation. That's the entire process for enrolling!
                        </p>
                        <p>
                            All enrollments for all your students will be displayed in your <a href="https://my.memorialacademy.org/dashboard">MyMAST dashboard</a>. This will always display up-to-date information for all your enrollments, including schedules, the location/meeting link, course information (if applicable), and contact information.
                        </p>
                    </Card.Norm>
                    <Card.Norm header="Are you a volunteer?">
                        <p>
                            When you create a volunteer account (by selecting "I'm a volunteer" during account creation), we'll save all the information you enter and automatically apply it to all of your future sign-ups.
                            <br/>
                            To volunteer for a program, visit the program's webpage (typically linked to from this website or a flyer) and click the large "Volunteer" button. You may have to answer a few more questions relating to specific weeks and/or courses you wish to volunteer for, in addition to an optional question allowing you to provide extra information about yourself (like scheduling conflicts, skills, prior volunteering experience, hobbies, etc.).
                        </p>
                        <p>
                            ...
                            <br/>
                            <ins>Note that we do not reject volunteering signups; all "pending" signups will become confirmed. Additionally, you will receive an assignment for every week you signed up for.</ins>
                        </p>
                        <p>
                            All your volunteer commitments, pending and confirmed, will be displayed in your <a href="https://my.memorialacademy.org/dashboard">MyMAST dashboard</a>. This will always display up-to-date information for all your sign-ups, including volunteering hours earned, schedules, the location/meeting link, course information (if applicable), and contact information.
                        </p>
                    </Card.Norm>
                </Section>
                <Section heading="Why do I have to create an account?">
                    ...
                    <Card.Norm header="But I'm worried about my data!">
                        ...
                        <p>
                            In MyMAST, all data is access-controlled and restricted to only users who need to access that data. Direct access to servers and databases is only possible over secure connections and via strong authentication credentials. Information such as passwords are irreversibly encrypted before being stored, and all connections to MyMAST are automatically secured/encrypted by your browser (by the way, these are all concepts covered in Let's Code!).
                        </p>
                    </Card.Norm>
                </Section>
