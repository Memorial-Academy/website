        ...
        <>
            ...
            <main>
                <Section heading="Empowering Young Minds">
                    <>
                        <p>The Memorial Academy of Science and Technology (MAST) was founded to provide students of all backgrounds (especially ones of low-income/low-opportunity) a way to gain access to high quality learning experiences. We pride ourselves in offering programs developed by passionate students, highly experienced in their respective fields, that are designed with three goals in mind:</p>
                        <ol>
                            <li><b>Use real world tools/lessons.</b> Most summer camps use proprietary tools. While these can be useful at first, these skills are difficult to expand on. All of our programs use tools accessible from home, allowing students to continue learning and experimenting after leaving MAST! In many cases, these tools can also be used in real-world applications, allowing students to develop professional skills while furthering their education!</li>
                            <li><b>No-cost or low-cost.</b> We believe access to high-quality education and learning opportunities is a right; a person's social/economic background should not limit their ability to learn and grow! For that reason, we strive to ensure all of our programs are either free, or have a minimal cost for attendees.</li>
                            <li><b>Combine instructor-led demonstrations with student-led learning.</b> Instructors should act as catalysts in a student's learning experience. Our programs begin with short lessons packed with interactive demonstrations, led by our passionate & experience instructors, to give students a foundation to build upon. Then, we switch to student-led activities, where students will have to use their creativity and knowledge (with the supports of our volunteers and instructors) to apply and grow their skills.</li>
                        </ol>
                        <p>MAST's programs allow students to unlock new skills and explore new career paths in an environment specially designed to ensure success and foster creativity and learning. All are welcome to enroll!</p>
                    </>
                </Section>
                <Section heading="Programs">
                    <Card.Left image="./lets_code.svg" header="Let's Code">
                        ...
                        <p><b>New curriculums for 2025!</b> Whether you're a new or a returning student, we've got a week of exciting coding adventures awaiting you!</p>
